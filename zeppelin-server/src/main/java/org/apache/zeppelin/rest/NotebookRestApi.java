...
public class NotebookRestApi {
  ...
  /**
   * Check if the current user can run (at least he has to be runner) the given note.
   */
  ...
  public Response putNotePermissions(@PathParam("noteId") String noteId, String req)
    ...
    // Set readers, if writers, runners,  and owners is empty -> set to user requesting the change
